...
class Shareprints {
	...
	function init(){
		...
		//include_once( SHAREPRINTS_PLUGIN_DIR . 'public/views/gallery-types/edge-slider.php');
		//include_once( SHAREPRINTS_PLUGIN_DIR . 'public/views/gallery-types/edge-thumb-slider.php');
